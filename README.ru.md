...
* **Поиск обоев в Workshop** по заданным параметрам
* **Установка обоев** в один клик
* **Управление** установленными обоями
...
- **Интеграция со Steam Workshop**: Реализация стандартных возможностей веб-версии Steam Workshop, включая базовый поиск, сортировки и стандартные фильтры (по категориям, возрастному рейтингу, разрешению и др.).
- **Профили авторов**: Просмотр всех обоев и коллекций, опубликованных конкретным автором.
- **Коллекции**: Поддержка просмотра коллекций Steam и их содержимого.
- **Предзагрузка страниц**: Плавная навигация за счет фонового кэширования следующей страницы.
- **Перевод описаний**: Перевод описаний обоев (Google Translate API).
...
- **Поддержка аккаунтов Steam**: Использование встроенных публичных аккаунтов или добавление собственных (с поддержкой Steam Guard и авторизации по QR-коду).
- **Отслеживание прогресса**: Отображение процесса загрузки в реальном времени и возможность отмены скачивания.
- **Автоприменение**: Опция автоматического применения последних скачанных обоев по завершении загрузки.

</details>

<details>
<summary><b>Управление библиотекой</b></summary>

- **Применение и удаление**: Быстрое применение (активация) обоев на рабочем столе и их удаление.
- **Настройка параметров и пресеты**: Изменение свойств обоев в реальном времени (скорость воспроизведения, выравнивание, громкость, цветовые настройки, яркость, контраст и др.) и сохранение настроек напрямую в `project.json` (с автоматическим резервным копированием).
- **Групповые операции**: Режим мультивыбора для массового удаления или извлечения установленных обоев.
- **Декомпиляция через RePKG**: Распаковка `.pkg` файлов Wallpaper Engine в один клик.

</details>

<details>
<summary><b>Интеграция с Wallpaper Engine</b></summary>

- **Автоопределение**: Автоматический поиск папки с установленной Wallpaper Engine в системе.
- **Панель управления**: Интегрированная панель медиаконтроля (запуск, пауза, отключение звука, переключение обоев и скрытие ярлыков рабочего стола).
- **Плейлисты и профили**: Быстрый запуск плейлистов или профилей настроек Wallpaper Engine по названию прямо из панели управления.

</details>

<details>
<summary><b>Персонализация и управление</b></summary>

- **Темы интерфейса**: 6 вариантов оформления интерфейса и 10 акцентных цветов.
- **Глобальные хоткеи**: Полностью настраиваемые горячие клавиши для навигации, управления воспроизведением и открытия настроек.
- **Мультиязычность**: Интерфейс на русском и английском языках (с автоопределением языка системы при первом запуске).

</details>

*И другие не упомянутые функции*
