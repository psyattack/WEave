...
### <strong>开发中 2.0 - 迁移到 Tauri (React) + Rust 或 PyWebView。更简洁的UI，更快，更紧凑。</strong>
...
- [ ] 最小化后窗口状态返回不正确
- [x] 清除过滤器时的白色对话框
- [ ] PyInstaller --onefile会导致重启失败，如果需要从源码编译请使用--onedir模式（~500mb，因此未上传到发布版本）
