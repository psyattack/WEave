...
<p align="center">
  <img src="../screenshots/screen_main.png" alt="WEave (原 WE Workshop Manager)" width="700">
</p>

<p align="center">
  <strong>主要界面演示</strong>
</p>
...
WEave (原 WE Workshop Manager) 是一个 Python/PyQt6 桌面应用程序，让您可以轻松地从 Wallpaper Engine 的 Steam Workshop 下载、安装和管理壁纸，**无需运行 Steam 客户端**。

### <strong>开发中 2.0 - 迁移到 Tauri (React) + Rust 或 PyWebView</strong>
...
> - 首次登录可能需要一些时间，请等待系统账户登录
> - Workshop 下载速度取决于您的网络连接速度以及 Steam 服务器的可用性
> - 如果应用程序不显示 Workshop 中的"特定"内容，则意味着系统账户出于某种原因未登录。您需要在应用程序设置（常规）中登录任何 Steam 账户（无 Steam Guard 并包含您需要的内容设置）。
> - 如果壁纸无法加载 - 请尝试从设置（账户）列表中选择另一个账户。
...
> [!IMPORTANT]
> **要从源代码运行（选项2）：**
> - 安装 [Python 3.10+](https://www.python.org/downloads)（已在 Python 3.14.2 上测试）
> - 安装 [.NET 8](https://dotnet.microsoft.com/download/dotnet/8.0/runtime) 或 [.NET 9](https://dotnet.microsoft.com/download/dotnet/9.0/runtime) Desktop Runtime
>
> **对于打包版本（选项1）：**
> - 只需上述 .NET Runtime
...
> 所有依赖项已在压缩包中，只需将压缩包解压到方便的位置并运行 `WEave.exe`
